...
class Descuentos
{
    ...
    function newDescuento ($data) {
        ...
        if (empty($datadescuento->nom_descuento)) {
            ...
            $sql = "Insert into descuentos (nom_descuento,descripcion,descuento) values ('$datadescuento->nom_descuento','$datadescuento->descripcion','$datadescuento->descuento')";
