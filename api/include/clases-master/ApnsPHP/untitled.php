...
$onclick = ($item->id == 148 || $item->id == 149 || $item->id == 150 || $item->id == 151 || $item->id == 152)? 'onclick="goTo('.$item->id.');"':'';
...
<!-- Intro Image -->
<figure class="item_img img-intro img-intro__<?php echo htmlspecialchars($params->get('intro_image_align')); ?>" <?php echo $onclick;?> > 
